...
For the purposes of this blog I used the Tabular version since it had a pre-built binary available on https://www.confluent.io/hub/[Confluent Hub] which made it easier to install.

[NOTE]
====
As of May 2026, if you want to use the Apache Iceberg version of the connector you can find a version on https://www.confluent.io/hub/iceberg/iceberg-kafka-connect[Confluent Hub], and if it's out of date you'll https://iceberg.apache.org/docs/nightly/kafka-connect/#installation[need to build the connector yourself].
There is https://github.com/apache/iceberg/issues/10745[work underway] to automatically make the latest version available on Confluent Hub.
====
...
Hot off my blog post about link:/2025/06/24/writing-to-apache-iceberg-on-s3-using-flink-sql-with-glue-catalog/[doing this in Flink SQL], I had in my mind that the table needed a three-part qualification; `catalog.database.table`.
...
This time one that's built into Kafka Connect: link:/2020/12/15/twelve-days-of-smt-day-6-insertfield-ii/[`InsertField`]
