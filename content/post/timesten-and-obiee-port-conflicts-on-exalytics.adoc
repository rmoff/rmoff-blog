...
Whilst helping a customer set up their Exalytics server the other day I hit an interesting problem. Not interesting as in hey-this-will-cure-cancer, or oooh-big-data-buzzword interesting, or even interesting as in link:https://twitter.com/andybolton/status/359568006545809408/photo/1?ref=rittmanmead.com[someone-has-had-a-baby], but nonetheless, interesting if you like learning about the internals of the Exalytics stack.


The installation we were doing was multiple non-production environments on bare metal, a design that we developed on our own link:https://www.rittmanmead.com/blog/2012/05/rittman-mead-take-delivery-of-our-exalytics-server/[Rittman Mead Exalytics box] early on last year, and one that Oracle describe in their link:https://blogs.oracle.com/pa/entry/exalytics_v1_exalytics_deployment_guide?ref=rittmanmead.com[Exalytics white paper] which was published recently. Part of a multiple environment install is careful planning of the port allocations. OBIEE binds to many ports per instance, and there is also TimesTen to consider. I’d been through this meticuluously, specifying ports through the link:http://docs.oracle.com/cd/E28280_01/bi.1111/e10539/c4_installing.htm?ref=rittmanmead.com#BIEIG3205[`staticports.ini`] file when building the OBIEE domain, as well as in the link:http://docs.oracle.com/cd/E41246_01/bi.1/e39709/install_procedure.htm?ref=rittmanmead.com#CHDICIHC[`bim-setup.properties`] for TimesTen.
...
TimesTen itself cannot be configured in its behaviour with these ports - link:https://support.oracle.com/epmos/faces/DocContentDisplay?id=1295539.1&ref=rittmanmead.com[Doc ID 1295539.1] states:
