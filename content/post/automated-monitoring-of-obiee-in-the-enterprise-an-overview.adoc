...
* …link:http://en.wikipedia.org/wiki/List_of_systems_management_systems?ref=rittmanmead.com[list on Wikipedia]
...
If you think that this all sounds like overkill, then consider this link:http://rnm1978.wordpress.com/2010/03/05/whos-been-at-the-cookie-jar-ebs-bi-authentication-and-load-balancers/?ref=rittmanmead.com[real-life case here], where all the OBIEE processes were up, the database was up, the network ports were open, the OS stats were fine -- but the users still couldn't run their reports. Only by simulating the end-to-end user process can you get proper confidence that your monitoring *will* alert you when there is a problem
...
[line-through]##There has always been the BI Management Pack available as an extra for EM Grid Control, but it's not currently available for OBI 11g##. *Updated:* It looks like there is now, or soon will be, an OBI 11g management pack for EM 12c, see link:http://www.oracle.com/technetwork/oem/pdf/511863.pdf?ref=rittmanmead.com[here] and link:http://apex.oracle.com/pls/apex/f?p=44785:24:0:::24:P24_CONTENT_ID,P24_PREV_PAGE:6441,1&ref=rittmanmead.com[here] (h/t link:http://tipsonobiee.blogspot.co.uk/2012/09/oracle-enterprise-manager-12c-manage.html?ref=rittmanmead.com[Srinivas Malyala])
...
For further reading on this see Adam Bloom's presentation from this year's link:http://www.rittmanmead.com/biforum2012/?ref=rittmanmead.com[BI Forum]: link:http://www.rittmanmead.com/files/biforum2012/bloom_obi_diagnostics.pdf?ref=rittmanmead.com[Oracle BI 11g Diagnostics]
