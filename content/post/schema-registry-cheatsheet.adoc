...
The https://docs.confluent.io/current/schema-registry/docs/index.html[Schema Registry] support a REST API for finding out information about the schemas within it. Here's a quick cheatsheat with REST calls that I often use. 
