...
 (link:http://www.fotopedia.com/items/flickr-3296379139?ref=rittmanmead.com[image src])
...
I'm tempted to hyperlink these in the fashion of link:http://en.wikipedia.org/wiki/Choose_Your_Own_Adventure?ref=rittmanmead.com[Choose Your Own Adventure] and if you click straight from here onto the last section, Optimise, without having read the other parts first, it will redirect you back to them ;-)
