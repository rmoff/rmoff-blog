...
original_url: "https://www.decodable.co/blog/streaming-data-from-postgres-to-snowflake"
---
...
In my  link:/2024/10/15/why-do-i-need-cdc/[last blog post]  I looked at why you might need CDC.
...
<!--more-->
The data is a set of tables that take inspiration from Gunnar’s recent article about  link:https://www.morling.dev/blog/revisiting-the-outbox-pattern/[the Outbox pattern] .
