...
There are some interesting options, such as integration with the link:http://people.apache.org/~pmuellr/weinre/docs/latest/[Weinre] (WEb INspector REmote) development tool which could be very useful if developing advanced content for use with the new Oracle BI Mobile HD app. Other options I doubt are of use to those outside the product's development team. Here is the list:
