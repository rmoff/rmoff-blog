...
Unlike Oracle Universal Installer (OUI), you cannot specify a "response" file for the RCU, but can you can supply lots of options as command-line arguments. The full syntax is documented link:http://docs.oracle.com/cd/E23943_01/doc.1111/e14259/rcu_silent.htm#BABGFFCG[here]. 
