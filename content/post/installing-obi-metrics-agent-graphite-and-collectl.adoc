...
I’m using Oracle’s link:http://www.oracle.com/technetwork/middleware/bi-foundation/obiee-samples-167534.html?ref=rittmanmead.com[SampleApp v309R2] server which is built on Oracle Linux (OL) 5 so that anyone can try this out at home running it on VirtualBox (link:https://www.rittmanmead.com/blog/2013/06/using-obiee-sampleapp-305-in-vm-fusion/[or VMWare Fusion]). _I've also tested this on the latest link:http://www.oracle.com/technetwork/middleware/bi-foundation/obiee-samples-167534.html?ref=rittmanmead.com[SampleApp v406] - there is one additional step to run, see the paragraph below for details_
...
The script will take a few minutes to run. Once complete, you can test the installation following the steps below. Do note that Graphite is somewhat notorious for installation problems, so whilst these instructions have been tested, you may hit quirks on your own server that may need a bit of link:http://en.wiktionary.org/wiki/Google-fu?ref=rittmanmead.com[Google-Fu] to resolve. If you want to follow step-by-step instructions detailing each step, they are provided:


* link:https://github.com/RittmanMead/obi-metrics-agent/blob/master/INSTALL_GRAPHITE_OL5.md?ref=rittmanmead.com[Oracle Linux 5] (including Cent OS 5 and RHEL 5)
* link:https://github.com/RittmanMead/obi-metrics-agent/blob/master/INSTALL_GRAPHITE_OL6.md?ref=rittmanmead.com[Oracle Linux 6] (including Cent OS 6 and RHEL 6)
...
For further details and syntax examples, see the link:https://github.com/RittmanMead/obi-metrics-agent/blob/master/USAGE.md?ref=rittmanmead.com[USAGE.MD] file in the github repository.
