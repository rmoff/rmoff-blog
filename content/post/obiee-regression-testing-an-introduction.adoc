...
* Telling a computer to fetch some data twice and compare the first result with the second is link:http://dictionary.cambridge.org/dictionary/british/bread-and-butter?ref=rittmanmead.com[bread and butter] automation.
