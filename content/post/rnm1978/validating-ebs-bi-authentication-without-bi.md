...
date: "2010-05-17T15:42:12+0100"
image: "/images/2010/05/2010-05-17_1155081.webp"
categories:
- obia
- obiee
- security
...
<!--more-->
1. Login to EBS  
   ![](/images/2010/05/2010-05-17_1155081.webp "2010-05-17_115508")
...
3. Record the value of acf (eg `101507310`)  
    ![](/images/2010/05/2010-05-17_1201361.webp "2010-05-17_120136")
4. Record the value of the cookie that’s passed to BI. It should normally match the EBS TNS name (but doesn’t have to). In this example it’s EBSBIS1A, and the value is `_ACpwGUoeCKUX7GilVh7ZZKR:S`  
    ![](/images/2010/05/2010-05-17_1307451.webp "2010-05-17_130745")

3. Use sqlplus to open a connection to the EBS database using the ID that BI connects as (eg EBS\_BI)
