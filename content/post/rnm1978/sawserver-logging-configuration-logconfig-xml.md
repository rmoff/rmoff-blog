...
*(Image no longer available)*Logging Detail  
...
*(Image no longer available)*This configuration is in the Writer definition, in the case of format set fmtName=”short”  
