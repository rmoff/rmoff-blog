...
date: "2009-07-29T10:47:42+0000"
image: "/images/2009/07/jmanage13.webp"
categories:
- jManage
- jmx
- monitoring
...
![jmanage13](/images/2009/07/jmanage13.webp "jmanage13")
...
3. Start the agent by running runagent.cmd (or .sh if it’s a unix installation). You should get this kind of output:
   ...
   ```
4. If you want to be sure it’s working, use jconsole to connect and examine the MBeans exposed. [See here for more information](/post/rnm1978/jconsole-jmx/)
...
8. Leave Username, Password, java.naming.factory.initial and java.naming.provider.url as they default to on the form![jmanage02](/images/2009/07/jmanage02.webp "jmanage02")
9. Click Save
10. If it’s worked then you should be back at the Managed Applications page with your server listed and hopefully a green icon next to it, indicating that jManage has successfully connected![jmanage03](/images/2009/07/jmanage03.webp "jmanage03")
...
![jmanage05](/images/2009/07/jmanage05.webp "jmanage05")
...
![jmanage07](/images/2009/07/jmanage07.webp "jmanage07")
...
![jmanage08](/images/2009/07/jmanage08.webp "jmanage08")
...
For example, the object detailing performance data about our data warehouse connection pool, **Oracle BI=Performance,AppName=Oracle BI Server,type=Oracle BI DB Connection Pool,name=Star\_Oracle Data Warehouse\_Oracle Data Warehouse Connection Pool**, is going to be of more interest than all the Configuration objects, plus a bunch of performance objects that we probably won’t examine too closely that often.  
...
![jManage Management Console_1248864159305](/images/2009/07/jmanage-management-console_1248864159305.webp "jManage Management Console_1248864159305")  
Your new object is displayed on the application home page:  
![jmanage15](/images/2009/07/jmanage15.webp "jmanage15")  
...
![jmanage09](/images/2009/07/jmanage09.webp "jmanage09")  
To do this click on Add Alert from the application page, or Monitor when browsing the Management Objects  
![jmanage10](/images/2009/07/jmanage10.webp "jmanage10")

![jmanage11](/images/2009/07/jmanage11.webp "jmanage11")
...
![jmanage14](/images/2009/07/jmanage14.webp "jmanage14")  
...
![jmanage16](/images/2009/07/jmanage16.webp "jmanage16")
