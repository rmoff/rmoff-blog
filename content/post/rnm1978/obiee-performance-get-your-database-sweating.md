...
```bash
\[user@server\]/data/bi/tmp $ls -lrt total 112914646 \[...\] -rw------- 1 user biadmin 29122976800 Apr 6 11:32 nQS\_20117\_465\_33898735.TMP -rw------- 1 user biadmin 24816966976 Apr 6 11:12 nQS\_20117\_464\_33792457.TMP -rw------- 1 user biadmin 3582054936 Apr 6 11:46 nQS\_20117\_469\_37979712.TMP \[...\]
```
...
```
Total time row num db cum num START\_TS END\_TS sec count query db row

06-APR 10:05 10:18 579 0 6 3,436,816 06-APR 10:05 10:18 553 0 4 3,239,101 06-APR 10:05 10:18 383 0 3 1,624,656 06-APR 10:11 11:48 5694 0 1 13,894,550 06-APR 10:11 11:48 4314 0 1 11,840,156 06-APR 10:21 10:27 336 456 4 3,239,101
```
...
Another thing to check is the NQQuery.log, looking at the number of bytes returned from a database query. This could feed into some kind of generated alert for closer investigation if a query returns above a certain number. OBI 10g: 
```bash
...
```
\[nQSError: 10058\] A general error has occurred. \[nQSError: 46118\] Out of disk space.
```
