...
date: "2011-03-11T11:33:14+0000"
image: "/images/2011/03/snag-2011-03-10-16-11-16-0000.webp"
categories:
- AWR
- io
- oracle
...
This post expands on one I made last year [here](/post/rnm1978/the-danger-of-averages-measuring-io-throughput//) about sampling frequency (of I/O throughput, but it’s a generic concept).  
...
![](/images/2011/03/snag-2011-03-10-16-11-16-0000.webp "SNAG-2011-03-10-16.11.16-0000")

![](/images/2011/03/snag-2011-03-11-09-52-42-0000.webp "SNAG-2011-03-11-09.52.42-0000")
...
The data is the average I/O throughput, sampled every five seconds ([through this method](/post/rnm1978/comparing-methods-for-recording-io-vsysstat-vs-hp-measureware//)). Note that already this is an average, but in the context of hourly samples (for example) we will have to live with five seconds as the starting point.

[![](/images/2011/03/io_compare_sampling_periods_01.webp "io_compare_sampling_periods_01")](/images/2011/03/io_compare_sampling_periods_01.webp)
...
[![](/images/2011/03/io_compare_sampling_periods_02.webp "io_compare_sampling_periods_02")](/images/2011/03/io_compare_sampling_periods_02.webp)
...
[![](/images/2011/03/io_compare_sampling_periods_03.webp "io_compare_sampling_periods_03")](/images/2011/03/io_compare_sampling_periods_03.webp)
...
[![](/images/2011/03/io_compare_sampling_periods_04.webp "io_compare_sampling_periods_04")](/images/2011/03/io_compare_sampling_periods_04.webp)
...
[![](/images/2011/03/io_compare_sampling_periods_05.webp "io_compare_sampling_periods_05")](/images/2011/03/io_compare_sampling_periods_05.webp)
...
So, I turned to twitter. Twitter is awesome. (I think of [Chet](http://www.oraclenerd.com) almost everytime I say this because he was one of the main guys who convinced me it was as good as the fuss made out. Check out his presentation all about it here [here](http://www.oraclenerd.com/2010/12/fun-day.html)).  
![](/images/2011/03/snag-2011-03-11-09-12-36-0000.webp "SNAG-2011-03-11-09.12.36-0000")  
and back the answers came:

![twitter is teh awesome](/images/2011/03/snag-2011-03-11-10-20-56-0000.webp "SNAG-2011-03-11-10.20.56-0000")
...
- [Database I/O Performance: Measuring and Planning – Alex Gorbachev](http://www.hotsos.com/sym11/sym_speakers_gorbachev.html)
  - *I started reading this today and am already scrawling huge “YES!” comments next to lots of it. I’d strongly recommend anyone trying to understand this subject get hold of a copy of the presentation, because it explains what I’ve rambled on about above in a much more clear and eloquent way.*
