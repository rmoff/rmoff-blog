...
In investigating the [problems with sawserver](/post/rnm1978/sawserver-wont-start-analytics-servlet-error-java-net-connectexception-connection-refused-errno239/) I was pointed towards a tool called [tusc](http://hpux.connect.org.uk/hppd/hpux/Sysadmin/tusc-7.9/) (which appears to be an HP version of truss).  
