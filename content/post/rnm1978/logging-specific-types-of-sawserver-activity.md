...
As well as tinkering with the sawserver (Presentation Services) [logging level](/2009/07/23/sawserver-logging-configuration-logconfig.xml/) and [format](/post/rnm1978/sawserver-log-short-format/), we can specific which bits of the log we're interested in. This is useful for two reasons:
