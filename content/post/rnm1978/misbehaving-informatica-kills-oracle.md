...
date: "2010-09-02T13:23:44+0100"
image: "/images/2010/09/inf_repo_exp_03.webp"
categories:
- bug
- informatica
- obia
...
![](/images/2010/09/inf_repo_exp_03.webp "inf_repo_exp_03")

### Server

Note SWAP space increase (dark blue line) at c. midday (nb GMT/BST mean not all the graphs will align):

![Database server metrics](/images/2010/09/inf_repo_exp_011.webp "inf_repo_exp_01")

Database server metrics

Note number of Alive Oracle processes (faint yellow line!):

![Database server metrics - Oracle application only](/images/2010/09/inf_repo_exp_021.webp "inf_repo_exp_02")
