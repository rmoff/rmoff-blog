...
date: "2009-10-22T13:30:17+0100"
image: "/images/2009/10/admintool1.webp"
categories:
- obiee
- oracle
---
...
To check your connection pool, open the RPD in Adminstration tool and go to the Physical Layer. Expand the Database, and double-click on the Connection Pool (if you’re not sure which one, then check all of them!). ![admintool1](/images/2009/10/admintool1.webp "admintool1")  
In the connection pool check the Data Source Name and make sure it matches to what you have in your tnsnames.ora file:  
![admintool2](/images/2009/10/admintool2.webp "admintool2")
...
I’ve not done extensive testing of this but until proven otherwise I would assume that OBIEE uses the tnsnames.ora in $ORACLE\_HOME/network/admin/  
$ORACLE\_HOME should be set in [OracleBI]/setup/user.sh or your user profile. Note that it’s the home for the connectivity (usually client), not necessarily your DB.  
...
Add this to your $TNS\_NAMES/sqlnet.ora file:

> trace\_level\_client = 10  
> trace\_unique\_client = on  
> trace\_file\_client = sqlnet.trc  
> trace\_directory\_client = /tmp

([source](http://www.orafaq.com/wiki/SQL*Net_FAQ#I_have_some_trouble_with_SQL.2ANet._How_does_one_produce_a_trace_file.3F))  
...
> (42) [22-OCT-2009 11:12:32:271] nnftrne: Original name: VALUE\_OF(OLAP\_DSN)  
...
> (42) [22-OCT-2009 11:12:32:271] nnfun2a: address for name “VALUE\_OF(OLAP\_DSN)” not found
