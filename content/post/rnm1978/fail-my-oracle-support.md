...
Clicking the Home link when going in on [this link](https://supporthtml.oracle.com/ep/faces/secure/ml3/patches/ARUPatchDownload.jspx) or trying to login from <http://supporthtml.oracle.com> gives **500 Internal Server** error on IE and “Recursive error in error-page calling for /secure/error.jspx, see the application log for details. ” in FireFox.
