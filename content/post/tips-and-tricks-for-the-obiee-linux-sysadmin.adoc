...
You can get the script from the link:https://github.com/RittmanMead/scripts/?ref=rittmanmead.com[Rittman Mead public GitHub repository], or directly download the link:https://raw.github.com/RittmanMead/scripts/master/obi/init.d/obiee?ref=rittmanmead.com[script here] (but don’t forget to check out the link:https://github.com/RittmanMead/scripts/blob/master/obi/init.d/README.md?ref=rittmanmead.com[README]).
...
* SSH keys are just plain text, making them dead easy to backup in a Password Manager such as link:https://lastpass.com/?ref=rittmanmead.com[LastPass], link:http://keepass.info/?ref=rittmanmead.com[KeePass], or link:https://agilebits.com/onepassword?ref=rittmanmead.com[1Password].
* SSH keys work just fine from Windows. Tools such as PuTTY and WinSCP support them, although you need to initially link:http://meinit.nl/using-your-openssh-private-key-in-putty?ref=rittmanmead.com[change the format of the private key to `ppk` using PuTTYGen, an ancillary PuTTY tool].
...
. Hey I wonder if link:http://devopsreactions.tumblr.com/?ref=rittmanmead.com[devopsreactions] has anything cool on it today
...
. Download the file
. That link:http://dbareactions.tumblr.com/?ref=rittmanmead.com[dbareactions] is pretty funny too, might just have a quick look at that
...
* OBIEE: link:http://docs.oracle.com/cd/E28280_01/bi.1111/e10539/c4_installing.htm?ref=rittmanmead.com#sthref160[Installing Oracle Business Intelligence in Silent Mode]
* RCU: link:http://docs.oracle.com/cd/E28280_01/doc.1111/e14259/rcu_silent.htm?ref=rittmanmead.com#BABIBJDI[Running Repository Creation Utility from the Command Line]
* WLS: link:http://docs.oracle.com/cd/E28280_01/doc.1111/e14142/silent.htm?ref=rittmanmead.com#i1083883[Running the Installation Program in Silent Mode]

We've shared link:https://github.com/RittmanMead/scripts/tree/master/obi/installs/response_files/11.1.1.7?ref=rittmanmead.com[some example response files] on the link:https://github.com/RittmanMead/scripts/?ref=rittmanmead.com[Rittman Mead public GitHub repository], or you can generate your own by running the installer once in GUI mode and selecting the *Save* option on the Summary screen of an installation. You can just run the installer to generate the response file - you don't have to actually proceed with the installation if all you want to do is generate the response file.
...
Which commands or techniques are you flabbergasted aren't on this list? What functionality or concept should all budding OBI sysadmin link:http://starwars.wikia.com/wiki/Padawan?ref=rittmanmead.com[padawans] learn? Let us know in the comments section below.
