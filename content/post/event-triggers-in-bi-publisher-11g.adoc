...
If you want to use your own parameter (rather than a system variable as above), then from my testing it appears that the issue link:https://forums.oracle.com/forums/thread.jspa?threadID=575654&ref=rittmanmead.com[described here in 2007] (link:https://supporthtml.oracle.com/ep/faces/secure/km/DocumentDisplay.jspx?id=859980.1&h=Y&ref=rittmanmead.com[MOS DocID 859980.1]) still holds: your Data Set parameter name must match the name of a global parameter defined in your package function.
...
Event Triggers are covered in link:http://docs.oracle.com/cd/E21764_01/bi.1111/e18862/T527073T560158.htm?ref=rittmanmead.com[the documentation here]
