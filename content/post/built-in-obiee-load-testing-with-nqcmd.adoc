...
...or two. Wait time, or "think time", is also important in producing a realistic load test. Unless you want to hammer your server just link:http://knowyourmeme.com/memes/i-did-it-for-the-lulz?ref=rittmanmead.com[for the lulz] to see how fast you can overload it, you'll want to make sure the workload you're simulating represents how it is actually used -- and in reality users will be pausing (thinking) between report requests. The -w flag provides this option to nqcmd.
