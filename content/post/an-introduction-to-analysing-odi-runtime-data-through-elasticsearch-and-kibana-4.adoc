...
Kibana dashboards are interactive, so you can click on a point in a graph to zoom in on that time period, as well as click & drag to select an arbitrary range. The latter technique is sometimes known as “Brushing”, and if I’m not describing it very well have a look at link:http://bl.ocks.org/wrobstory/7612013?ref=rittmanmead.com[this example here] and you’ll see in an instant what I mean.
