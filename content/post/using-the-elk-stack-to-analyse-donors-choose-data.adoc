...
link:http://www.donorschoose.org/about[Donor’s Choose] is an online charity in America through which teachers can post details of projects that need funding and donors can give money towards them. link:http://data.donorschoose.org/[The data from the charity] since it began in 2000 is available to download freely link:http://data.donorschoose.org/open-data/overview/[here] in several CSV datasets. In this article I'm going to show how to use the ELK stack of data discovery tools from link:https://www.elastic.co/[Elastic] to easily import some data (the link:http://data.donorschoose.org/open-data/donation-data/[donations dataset]) and quickly start analysing it to produce results such as this one:


image::/images/2015/04/07462elkodvis05-01.png[]


I’m assuming you’ve downloaded and unzipped link:https://www.elastic.co/products[Elasticsearch, Logstash and Kibana] and made Java available if not already. I did this on a Mac, but the tools are cross-platform and should work just the same on Windows and Linux. I’d also recommend installing link:https://github.com/lmenezes/elasticsearch-kopf[Kopf], which is an excellent plugin for the management of Elasticsearch.
...
If you’ve installed link:https://github.com/lmenezes/elasticsearch-kopf[Kopf] then you can see at a glance how much data has been loaded:
...
Click the toggle on one of the events to see the full data for it, including things like the donation amount, the message with the donation, and geographical details of the donor. You can find link:http://data.donorschoose.org/open-data/donation-data/[details of all the fields on the Donor's Choose website here].
...
* four-fifths included the link:http://help.donorschoose.org/hc/en-us/articles/202002613-Optional-donation-to-DonorsChoose-org-[optional donation] towards the running costs of Donor's Choose.
...
Let's look at some actual data analyses now. One of the most simple is the amount given in donations over time, split by amount given to project and also as the link:http://help.donorschoose.org/hc/en-us/articles/202002613-Optional-donation-to-DonorsChoose-org-[optional support] amount:
