...
* When you’re building grok statements and patterns, use the superb link:http://grokdebug.herokuapp.com[http://grokdebug.herokuapp.com]. The advantage of this over a standard regex debugger is that it supports the grok syntax of capture groups and even custom patterns.
