...
original_url: "https://www.decodable.co/blog/troubleshooting-flink-sql-s3-problems"
---
...
Having  link:/2024/04/17/flink-sqlmisconfiguration-misunderstanding-and-mishaps/[already written]  about the trouble that I had getting Flink SQL to write to S3 (including on MinIO) this should now be a moot issue for me.
Right?
RIGHT?!
