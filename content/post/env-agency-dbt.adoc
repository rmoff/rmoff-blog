...
dbt is a tool created in 2016 and that really exploded in popularity on the data engineering scene around 2020.
...
In (yet another) good example of how good a fit dbt is for this kind of work, it supports dimension data done 'right' and 'wrong'.
