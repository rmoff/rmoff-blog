...
* The rig I built to run the scenarios, evals, and LLM-as-judge assessments to see what impact different factors had on the quality of what was built.
    ...
    ** link:/2026/03/13/evaluating-claudes-dbt-skills-building-an-eval-from-scratch/[Evaluating Claude’s dbt Skills: Building an Eval from Scratch]
====
...
I've done that, and link:/2026/03/13/evaluating-claudes-dbt-skills-building-an-eval-from-scratch/[have written about it separately].
...
I've written all about this in link:/2026/03/13/evaluating-claudes-dbt-skills-building-an-eval-from-scratch/[a separate blog post], because I learnt a lot of stuff—some of it useful too.
