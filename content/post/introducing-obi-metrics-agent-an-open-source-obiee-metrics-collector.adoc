...
To explore the DMS metrics available, you can use Enterprise Manager, or the link:http://docs.oracle.com/cd/E15586_01/core.1111/e10108/monitor.htm#CFAHIAIB[DMS Spy] servlet that is installed by default with OBIEE and available at `http://<obi-server>:7001/dms/` (assuming your AdminServer is on port 7001).
...
Rittman Mead have released *obi-metrics-agent* as open source. You can find it on GitHub: link:https://github.com/RittmanMead/obi-metrics-agent[https://github.com/RittmanMead/obi-metrics-agent].
