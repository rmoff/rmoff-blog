...
OBIEE 12c has changed quite a lot in how it manages configuration. In OBIEE 11g configuration was based around link:https://docs.oracle.com/middleware/11119/biee/BIESG/configsettings.htm?ref=rittmanmead.com#BIESG1643[system MBeans] and the `biee-domain.xml` as the master copy of settings - and if you updated a configuration directly that was centrally managed, it would get reverted back. Now in OBIEE 12c configuration link:https://docs.oracle.com/middleware/1221/biee/BIESG/em_wls_config.htm?ref=rittmanmead.com#BIESG9332[can be managed directly in text files again] - but also link:https://docs.oracle.com/middleware/1221/biee/BIESG/em_wls_config.htm?ref=rittmanmead.com#BIESG1637[through EM] still (not to mention link:https://docs.oracle.com/middleware/1221/biee/BIESG/em_wls_config.htm?ref=rittmanmead.com#BIESG9333[WLST]). Confused? Yep, I was.
