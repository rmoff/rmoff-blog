...
original_url: "https://www.decodable.co/blog/migrating-apache-flink-jobs-from-amazon-msf-to-decodable"
classes:
- feature-nohdr
---
...
== Resources
* link:https://info.decodable.co/decoding-the-top-4-real-time-data-platforms-powered-by-apache-flink[Decoding the Top 4 Real-Time Data Platforms Powered by Apache Flink] : Considerations for selecting a platform for ETL and stream processing at scale
* link:https://info.decodable.co/ebk-the-blueprint-for-success-with-real-time-etl-data[The Blueprint for Success with Real-time Data] : Accelerate your real-time ETL, ELT, and streaming initiatives with Decodable
* Sign up for your  link:https://app.decodable.co/-/accounts/create[free Decodable account]  today and give it a try!