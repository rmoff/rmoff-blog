...
We are firm believers in a practical and logical approach to performance analytics and optimisation. Eschewing the link:http://www.brendangregg.com/methodology.html[drunk man anti-method] of ‘tuning’ configuration settings at random, we advocate making a clear diagnosis and baseline of performance problems _before_ changing anything. Once a clear understanding of the situation is established, steps are taken in a controlled manner to implement *and validate* one change at a time.


Rittman Mead have link:https://oracleus.activeevents.com/2014/connect/sessionDetail.ww?SESSION_ID=9095[spoken at conferences], produced videos, and written many blogs specifically on the subject of OBIEE Performance.
