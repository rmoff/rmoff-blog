...
Oracle's link:https://www.oracle.com/big-data/big-data-discovery/index.html?ref=rittmanmead.com[Big Data Discovery] encompasses a good amount of exploration, transformation, and visualisation capabilities for datasets residing in your organisation’s data reservoir. Even with this though, there may come a time when your data scientists want to unleash their R magic on those same datasets. Perhaps the data domain expert has used BDD to enrich and cleanse the data, and now it's ready for some statistical analysis? Maybe you'd like to use R's excellent link:https://cran.r-project.org/web/packages/forecast/forecast.pdf?ref=rittmanmead.com[forecast] package to predict the next six months of a KPI from the BDD dataset? And not only predict it, but write it back into the dataset for subsequent use in BDD? This is possible using link:http://www.rittmanmead.com/2016/06/using-jupyter-notebooks-big-data-discovery-1-2/?ref=rittmanmead.com[BDD Shell] and `rpy2`. It enables advanced analysis and manipulation of datasets already in BDD. These modified datasets can then be pushed back into Hive and then BDD.


BDD Shell provides a native Python environment, and you may opt to use the pandas library to work with BDD datasets as link:http://www.rittmanmead.com/2016/06/using-jupyter-notebooks-big-data-discovery-1-2/?ref=rittmanmead.com[detailed here]. In other cases you may simply prefer working with R, or have a particular library in mind that only R offers natively. In this article we’ll see how to do that. The "secret sauce" is `rpy2` which enables the native use of R code within a python-kernel Jupyter Notebook.


As with link:http://www.rittmanmead.com/2016/07/using-sparksql-pandas-import-data-big-data-discovery/?ref=rittmanmead.com[previous articles] I’m using a link:http://www.rittmanmead.com/2016/06/using-jupyter-notebooks-big-data-discovery-1-2/?ref=rittmanmead.com[Jupyter Notebook] as my environment. I’ll walk through the code here, and finish with a copy of the notebook so you can see the full process.


First we'll see how you can use R in Jupyter Notebooks running a python kernel, and then expand out to integrate with BDD too. You can view and download link:https://gist.github.com/22cd8585894197c919726bd7092dc057?ref=rittmanmead.com[the first notebook here].
...
_For more information see link:http://rpy.sourceforge.net/rpy2/doc-dev/html/interactive.html?ref=rittmanmead.com[the documentation]_
...
You can download the link:https://gist.github.com/6f7d3138efdbb322d8543d35912c99ab?ref=rittmanmead.com[notebook here.]


link:https://gist.github.com/6f7d3138efdbb322d8543d35912c99ab?ref=rittmanmead.com[https://gist.github.com/6f7d3138efdbb322d8543d35912c99ab]
