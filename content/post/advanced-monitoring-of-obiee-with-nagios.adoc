...
* JMeter (link:http://jmeter.apache.org/download_jmeter.cgi?ref=rittmanmead.com[download the Binary from here]). Unarchive it into a folder, for example /u01/app/apache-jmeter-2.7/. Set the files in the binary folder to executable
+
[source]
----
