...
. In accessing it you're bound by the same link:http://www.oracle.com/technetwork/licenses/biee-sample-app-vm-license-2209742.html?ref=rittmanmead.com[terms and conditions] that govern the original SampleApp
...
. Create yourself an AWS account, if you haven't already. You'll need your credit card for this. Read more about link:http://aws.amazon.com/getting-started/?nc2=h_l2_cc/&ref=rittmanmead.com[getting started with AWS here].
...
You can get an estimate of the cost involved using the link:http://calculator.s3.amazonaws.com/index.html?ref=rittmanmead.com[Amazon Calculator].
...
You can track your AWS usage through link:http://docs.aws.amazon.com/gettingstarted/latest/awsgsg-intro/gsg-aws-track-usage.html?ref=rittmanmead.com[the AWS page here].
...
. Select an *Instance Type*. An "m3.large" size is a good starting point (link:http://www.ec2instances.info/?ref=rittmanmead.com[this site] is useful to see the spec of all instances).
+
...
By completing the form and requesting access to the AMI, you are acknowledging that you have read and understood the link:http://www.oracle.com/technetwork/licenses/biee-sample-app-vm-license-2209742.html?ref=rittmanmead.com[terms and conditions set out by Oracle here].
