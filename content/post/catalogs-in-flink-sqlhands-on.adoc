...
I mentioned Catalog Stores in my  link:https://decodable.co/blog/catalogs-in-flink-sql-a-primer[first blog post] , and I've not defined one—meaning that the catalog _definition_ is not persisted between sessions.
