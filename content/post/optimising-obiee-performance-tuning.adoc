...
[quote]
____
_The only “best practice” you should be using all the time is “Use Your Brain”. – *link:https://twitter.com/OracleAskTom/status/240813515290603521?ref=rittmanmead.com[Tom Kyte]*_
____
...
+
+
* Size hardware correctly to support the BI Server and Presentation Server (based on past experience and/or Oracle’s link:https://support.oracle.com/epmos/faces/DocContentDisplay?id=1323646.1&ref=rittmanmead.com[documentation])
* Make sure that there a balanced hardware configuration throughout the stack (c.f. link:http://structureddata.org/2009/12/22/the-core-performance-fundamentals-of-oracle-data-warehousing-balanced-hardware-configuration/?ref=rittmanmead.com[Greg Rahn] and link:http://docs.oracle.com/cd/E11882_01/server.112/e10578/tdpdw_system.htm?ref=rittmanmead.com#CFHFJEDD[Oracle documentation])
...
. link:http://docs.oracle.com/cd/E23943_01/bi.1111/e10541/querycaching.htm?ref=rittmanmead.com#i1005542[Event Polling Table]
. link:http://docs.oracle.com/cd/E23943_01/bi.1111/e10541/querycaching.htm?ref=rittmanmead.com#i1010207[ODBC/JDBC command] to the BI Server, triggered by the completion of a data load (ETL)
