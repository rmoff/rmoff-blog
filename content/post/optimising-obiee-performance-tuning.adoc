...
Mark Rittman wrote a post recently in which he discussed the idea of scaling the BI Server (nqsserver) component in order to take advantage of multiple CPU cores, and whether this was in fact necessary. You can read his post here : link:/2013/03/does-the-bi-server-system-component-make-full-use-of-my-multi-socket-multi-core-server/[Does the BI Server System Component Make Full Use of My Multi-Socket, Multi-Core Server?]
...
* Appropriate use of Parallel query, including Auto DOP (link:/2013/03/you-probably-need-parallel-except-when-you-dont/[as written about by my colleague Pete Scott recently])
* Partitioning
