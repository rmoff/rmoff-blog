...
Learn more about https://rmoff.net/2020/01/22/kafka-connect-and-schemas/[schemas in Kafka Connect here].
====
...
TIP: If you don't have the option of adding this schema to the producer writing the data, there is https://rmoff.net/2020/01/22/kafka-connect-and-schemas/[a hacky way that you can embed your payload in a schema using kafkacat].
...
* An example of the https://rmoff.net/2020/01/21/monitoring-sonos-with-ksqldb-influxdb-and-grafana/[InfluxDB connector in action]
