...
Microsoft's link:http://technet.microsoft.com/en-us/sysinternals/bb545021.aspx?ref=rittmanmead.com[*SysInternals* suite] includes the program *ProcMon*. You can point this at a running process and see what it's up to in terms of file access, DLLs, and networking. It is great for detecting things like:
