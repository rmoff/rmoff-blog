...
NB: The above java code is heavily based on link:http://oraclebizint.wordpress.com/2008/01/04/oracle-bi-publisher-101331-creating-applications-using-jdeveloper-11g-and-web-service-soap-apis/?ref=rittmanmead.com[Venkat's original code here].
