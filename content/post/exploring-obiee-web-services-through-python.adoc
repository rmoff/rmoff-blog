...
Once authenticated, we can call a Web Service which shows the Subject Areas that the user may see. The *MetadataService* and *getSubjectAreas* are both straight from link:http://docs.oracle.com/cd/E28280_01/bi.1111/e16364/methods.htm[the documentation], transposed into SUDS/Python syntax.
...
And this matches the link:http://docs.oracle.com/cd/E28280_01/bi.1111/e16364/structures.htm#i1017326[AccountStructure] in the documentation (displayName doesn’t do anything in this method). We can set the object’s attributes to define the accounts we want to see - any account name (* is wildcard), and show users (accountType=0) only, not application roles:
...
See the link:https://fedorahosted.org/suds/wiki/Documentation#LOGGING[SUDS documentation] for more detail.
...
* link:http://docs.oracle.com/cd/E28280_01/bi.1111/e16364/methods.htm[Description of Services and Methods in Oracle BI EE Web Services]
* link:http://docs.oracle.com/cd/E28280_01/bi.1111/e16364/structures.htm[Description of Structures in Oracle BI EE Web Services]
* link:http://sourceforge.net/projects/soapui/files/[SoapUI] - invaluable for testing methods, checking structures, and eliminating/identifying your code as the fault for any errors you hit. The free version does everything you need. Good tutorial on SOAP/WSDL link:http://www.soapui.org/SOAP-and-WSDL/getting-started.html[here]
...
(Well, I think it’s cool, but then I link:http://www.youtube.com/watch?v=njos57IJf-0[laughed at this] so go figure)
