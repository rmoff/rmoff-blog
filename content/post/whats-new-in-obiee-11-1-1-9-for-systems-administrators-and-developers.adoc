...
One little grumble (link:https://www.youtube.com/watch?v=U74s8nFE7No&ref=rittmanmead.com[no pleasing some people…]) - it would have been nice if Usage Tracking also stored:
...
Note that there is no MBean for Init Block Usage Tracking, so regardless of how you configure the rest of Usage Tracking, link:https://docs.oracle.com/middleware/11119/biee/BIESG/usage_track.htm?ref=rittmanmead.com#BIESG3758[you need to go to NQSConfig.ini to enable this one].
...
You'll find documentation for the Web Services in the link:https://docs.oracle.com/middleware/11119/biee/BIEIT/methods.htm?ref=rittmanmead.com#CHDHEHAG[Integrator's Guide].
