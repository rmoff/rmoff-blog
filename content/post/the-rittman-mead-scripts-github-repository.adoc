...
Another part of working smarter is the use of a good VCS (Version Control System). link:http://www.rittmanmead.com/author/stewart-bryson/[Stewart] has already been preaching the good word over at his link:https://www.rittmanmead.com/blog/2013/05/mds-xml1/[git and OBIEE series], and needless to say we use git for looking after our scripts too.


Today we’re opening up our scripts git repository, making several of our scripts available to the OBIEE and ODI community. You can find it on github link:https://github.com/RittmanMead/scripts/[here], or clone it directly using the URL `git@github.com:RittmanMead/scripts.git` in your git client, or from the commandline:
...
Obviously, we’re holding a few gems back, after all, we’ve all got to eat right? But we’d like to see community participation in the repository, so go ahead and use it, link:https://help.github.com/articles/fork-a-repo[fork] it and make improvements, add your own scripts, and submit a link:https://help.github.com/articles/using-pull-requests[pull] request to merge them back in to share with the community again. To keep track of what's going on and when new scripts are added, you can link:https://help.github.com/articles/watching-repositories[watch it on github].
...
The configuration required is minimal; just the `FMW_HOME` (where OBIEE is installed), and optionally where you want log files written and under which user to run OBIEE. If you haven't already, you'll want to link:http://docs.oracle.com/cd/E28280_01/web.1111/e13708/overview.htm#i1068920[configure boot.properties] so that you're not prompted for credentials each time you start/stop WebLogic.


You’ll find the script in link:https://github.com/RittmanMead/scripts/tree/master/obi/init.d/obiee[obi/init.d/obiee] with full details on how to set it up and use it in the associated link:https://github.com/RittmanMead/scripts/tree/master/obi/init.d/README.md[README.md]
...
Last but no means least in this list is a script by link:http://www.rittmanmead.com/author/stewart-bryson/[Stewart Bryson]. Find out more by following the forthcoming posts in his link:https://www.rittmanmead.com/blog/2013/05/mds-xml1/[Git and OBIEE] blog series, but I will say this, it looks very useful if you're doing anything with MDS XML....
