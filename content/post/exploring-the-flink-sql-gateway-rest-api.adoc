...
It’s worth noting that it’s recommended to use  link:https://nightlies.apache.org/flink/flink-docs-master/docs/deployment/overview/#application-mode[application mode]  when deploying production jobs to Flink—and the SQL Client and Gateway don’t support this yet.
There is a  link:https://cwiki.apache.org/confluence/display/FLINK/FLIP-316%3A+Support+application+mode+for+SQL+Gateway[FLIP under discussion]  but in the meantime if you want to use application mode you’d need to wrap your SQL in a JAR to deploy it.
...
_I’ve shared a copy of my Postman collection with the above variable configuration done for you_ link:https://gist.github.com/rmoff/81b3e1b7effff90b547e9017d31dcc6d[here]
...
=== Where Next?
If you want to learn more about Flink SQL you might be interested in understanding more about the  link:https://www.decodable.co/blog/catalogs-in-flink-sql-a-primer[role of the Catalog] ,  link:https://www.decodable.co/blog/catalogs-in-flink-sql-hands-on[hands-on examples]  of using the Catalog, or a deep dive into  link:https://www.decodable.co/blog/flink-sql-and-the-joy-of-jars[using JARs with Flink SQL] .
