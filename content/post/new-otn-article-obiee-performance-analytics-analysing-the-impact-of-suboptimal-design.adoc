...
I’m pleased to have recently had my first article published on the link:http://www.oracle.com/technetwork/index.html[Oracle Technology Network (OTN)]. You can read it in its full splendour and glory(!) link:https://community.oracle.com/docs/DOC-993649[over there], but I thought I’d give a bit of background to it and the tools demonstrated within.
...
link:https://www.youtube.com/playlist?list=PLFY1_sCDBPebV2mlY7AOUFAq7U1LsMiy7[https://www.youtube.com/playlist?list=PLFY1_sCDBPebV2mlY7AOUFAq7U1LsMiy7]
