...
. In 11.1.1.3 -> 11.1.1.5 -> 11.1.1.6, the in-place upgrade was link:https://www.rittmanmead.com/blog/2011/05/in-place-upgrading-of-obiee-11-1-1-3-to-11-1-1-5/[complex] and link:https://groups.google.com/forum/?fromgroups=&ref=rittmanmead.com#!topic/obiee-enterprise-methodology/hXw1n8qxlKM[infamous for being buggy]. From what I’ve seen of two separate in-place 11.1.1.6 -> 11.1.1.7 upgrades it is simple to do and with no problems discovered _yet_.
...
link:http://www.artofbi.com/?ref=rittmanmead.com[Christian Screen] wrote about link:http://www.artofbi.com/index.php/2012/04/reasons-to-conduct-an-out-of-place-upgrade/?ref=rittmanmead.com[the advantages of an out of place upgrade], but I think some of these could be less relevant now. Given the simplicity of the in-place upgrade, out-of-place strikes me as more complex and risky.


== Getting started


Take a full backup of your OBIEE installation. You do take backups, right? If not, now is a very good time to start, upgrade or not. See the link:http://docs.oracle.com/cd/E23943_01/core.1111/e10105/br_intro.htm?ref=rittmanmead.com#ASADM11238[backup documentation, here]


Next, regardless of upgrade method, you need to download the complete OBIEE 11.1.1.7 installers for your platform, link:http://www.oracle.com/technetwork/middleware/bi-enterprise-edition/downloads/bi-downloads-1923016.html?ref=rittmanmead.com[from here]
...
An in-place upgrade will upgrade your existing 11g (whether 11.1.1.3, 11.1.1.5, or 11.1.1.6) to 11.1.1.7. It is documented here: link:http://docs.oracle.com/cd/E28280_01/upgrade.1111/e16452/bi_plan.htm?ref=rittmanmead.com#BABECJJH[Moving from 11.1.1.3, 11.1.1.5, or 11.1.1.6 to 11.1.1.7].
...
+
. Run the link:http://docs.oracle.com/cd/E23943_01/doc.1111/e16793/patch_set_assistant.htm?ref=rittmanmead.com#PATCH604[Patch Set Assistant] (PSA). This is located in `oracle_common/bin/` and is called `psa` on Linux or `psa.cmd` on Windows
...
You can download the response files used link:https://gist.github.com/rmoff/5299950?ref=rittmanmead.com[from here], or generate them yourself using the utilities in GUI mode.
...
* link:http://docs.oracle.com/cd/E28280_01/doc.1111/e14770/biee.htm?ref=rittmanmead.com#CACJAEBA[Configuration Assistant for Update BI Domain Steps Incorrectly Reports an OCM Configuration Error at 91% Complete when Moving from Earlier 11g Releases]
* link:http://docs.oracle.com/cd/E28280_01/doc.1111/e14770/biee.htm?ref=rittmanmead.com#CACFGGIH[Managed Server for Oracle BI Encounters Issues After Upgrade from Release 11.1.1.3]
* link:http://docs.oracle.com/cd/E28280_01/doc.1111/e14770/biee.htm?ref=rittmanmead.com#CHDFIJDG[SSL Configured in Oracle BI EE 11.1.1.5.x or 11.1.1.6.x Fails After Upgrading to 11.1.1.7.0]
