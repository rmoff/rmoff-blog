...
Note that OBIEE itself will perform cache purges in some situations including link:https://docs.oracle.com/cd/E28280_01/bi.1111/e10541/querycaching.htm#BIESG281[if a dynamic repository variable] used by a Business Model (e.g. in a Logical Column) gets a new value through a scheduled initialisation block.
...
. In the Physical table, setting link:https://docs.oracle.com/cd/E28280_01/bi.1111/e10540/physicallayer.htm#BABEAGGF[*Cache persistence time*]. Why not? Because this time period starts from _when the data was loaded into the cache_, *not* _when the data was loaded into your database_.  +
...
. link:https://docs.oracle.com/cd/E28280_01/bi.1111/e10541/querycaching.htm#BIESG248[BI Server Cache Purge Procedures]
. link:https://docs.oracle.com/cd/E28280_01/bi.1111/e10541/querycaching.htm#BIESG274[Event Polling Table]
...
As well as supporting queries for data from clients (such as Presentation Services) sent as Logical SQL, the BI Server also has its own set of procedures. Many of these are internal and mostly undocumented (link:https://oracleus.activeevents.com/2014/connect/fileDownload/session/75F302D730BDB9CA14ADAB3477574D4D/UGF9144_Berg-OOW_Neos_Voyage_2014.pdf[Christian Berg does a great job of explaining them here], and they do creep into link:https://docs.oracle.com/cd/E28280_01/bi.1111/e16364/bi_server_web_services.htm#BIEIT3248[the documentation here] and link:https://docs.oracle.com/cd/E28280_01/bi.1111/e10541/logging.htm#BIESG3823[here]), but there are some cache management ones that are link:https://docs.oracle.com/cd/E28280_01/bi.1111/e10541/querycaching.htm#BIESG248[fully supported and documented]. They are:
...
. JDBC - just requires the link:https://docs.oracle.com/cd/E28280_01/bi.1111/e10541/logging.htm#BABJEDDF[OBIEE JDBC driver], which is a single `.jar` file and thus portable
...
. Trigger it from a link:https://docs.oracle.com/cd/E28280_01/bi.1111/e16364/soa_overview.htm#BIEIT3171[Web Service] in order to couple it to your ETL data load / cache purge batch steps.
+
...
In this example here I’m running a very simple report from link:http://www.oracle.com/technetwork/middleware/bi-foundation/obiee-samples-167534.html[SampleApp v406]:
...
We see it in Usage Tracking (again, if you don’t have this enabled, link:https://docs.oracle.com/cd/E28280_01/bi.1111/e10541/usage_track.htm#BIESG189[go and enable it now]):
