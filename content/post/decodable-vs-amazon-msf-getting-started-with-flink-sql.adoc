...
original_url: "https://www.decodable.co/blog/decodable-vs-msf-getting-started-with-flink-sql"
classes:
- feature-nohdr
---
...
Having explored Flink SQL for myself  link:/2024/02/16/catalogs-in-flink-sqla-primer/[over]   link:/2024/02/19/catalogs-in-flink-sqlhands-on/[the]   link:/2024/04/17/flink-sqlmisconfiguration-misunderstanding-and-mishaps/[past]   link:/2024/03/12/exploring-the-flink-sql-gateway-rest-api/[few]   link:/2024/02/27/flink-sql-and-the-joy-of-jars/[months]  I knew to go and look up the  link:https://nightlies.apache.org/flink/flink-docs-master/docs/connectors/table/kafka/[Kafka connector for Flink] .
...
----
I’ve encountered  link:/2024/04/17/flink-sqlmisconfiguration-misunderstanding-and-mishaps/[this error]   link:/2024/02/27/flink-sql-and-the-joy-of-jars/[previously] .
...
You’ll enjoy  link:/2024/02/27/flink-sql-and-the-joy-of-jars/[this blog]  that I wrote) and upload it to S3:
...
One point to note here is that the EMR document talks about creating Flink `CATALOG` objects—I’d recommend you review my  link:/2024/02/16/catalogs-in-flink-sqla-primer/[primer on catalogs in Flink]  too if you haven’t already, since it’s an area full of ambiguity and overloaded terms.
...
Back to our story.
I spent a bunch of time learning about  link:/2024/02/27/flink-sql-and-the-joy-of-jars/[JARs in Flink]  so was happy taking on this error.
