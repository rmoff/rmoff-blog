...
Last year I wrote about link:http://www.rittmanmead.com/blog/2012/09/alternatives-to-the-summary-advisor-for-refreshing-exalytics-aggregates/[Alternatives to the Summary Advisor] when considering how to build and maintain these aggregates in TimesTen on Exalytics. This is something I also discussed in my recent UKOUG presentation, link:http://www.slideshare.net/themoff/exalytics-one-size-fits-all?ref=rittmanmead.com[Exalytics - One Size Fits All?]. In these, I outlined how the functionality “out of the box” works, and also why you might want to consider alternatives, the key reasons for which are:
...
+
. *Oracle connection details* from TimesTen. This can be defined using a TNS entry - but you then need to make sure TimesTen is configured with the correct tnsnames.ora file- or more easily using link:http://docs.oracle.com/cd/E11882_01/network.112/e10836/naming.htm?ref=rittmanmead.com#i498306[EasyConnect] syntax such as
...
_NB. If more granular security is required then see link:http://docs.oracle.com/cd/E13085_01/doc/timesten.1121/e13070/privileges.htm?ref=rittmanmead.com[the documentation] for information on the privileges that can be granted to individual objects_
...
* TimesTen statistics gathering (link:http://docs.oracle.com/cd/E21901_01/doc/timesten.1122/e21643/proced.htm?ref=rittmanmead.com#CHDJIEFD[ttOptUpdateStats] / link:http://docs.oracle.com/cd/E21901_01/doc/timesten.1122/e21643/proced.htm?ref=rittmanmead.com#autoId60[ttOptEstimateStats]) after refreshing the data
...
Ultimately, the ease of support and development is not going to be as great as through an Enterprise-ready tool such as Oracle Data Integrator. At the moment, there is no link:http://docs.oracle.com/cd/E23943_01/integrate.1111/e12644/timesten.htm?ref=rittmanmead.com#CHDGIJDB[TimesTen ODI Knowledge Module] that takes advantage of the Load From Oracle option, but I wouldn’t be surprised if one were in the pipeline.


== Support, Limitations & Troubleshooting


. The 11.2.2.4 version of TimesTen, which provides the new CreateAndLoadFromOraQuery command, is only certified as part of the Exalytics patchset 2 (v1.0.0.2). For more details, link:http://docs.oracle.com/cd/E27027_01/bi.1/e24706/admin_patch.htm?ref=rittmanmead.com#CBHHEJCC[see here]
...
For more information about picking and setting a character set for your TimesTen datastore, see link:http://docs.oracle.com/cd/E21901_01/doc/timesten.1122/e21633/globalization.htm?ref=rittmanmead.com#TTOPR276[the documentation].
...
The solution is to strip out the BOM, which can be easily done on linux (link:http://www.linuxask.com/questions/how-to-remove-bom-from-utf-8?ref=rittmanmead.com[h/t]) using
