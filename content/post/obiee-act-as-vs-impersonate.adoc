...
Password sharing aside (it's zero-config! but a _link:http://media.giphy.com/media/4qANoeI3g45a0/giphy.gif?ref=rittmanmead.com[really really bad idea]_), OBIEE supports two methods for one user to access the system as if they were another: *Impersonation* and *Act As*.
...
* Act As: link:http://docs.oracle.com/cd/E28280_01/bi.1111/e10543/mgrgrpsusers.htm?ref=rittmanmead.com#BIESC1617[Enabling Users to Act for Others]
* Impersonate: link:https://blogs.oracle.com/pa/entry/how_to_use_obiee_impersonate?ref=rittmanmead.com[How to use OBIEE Impersonate parameter for quick checks]
