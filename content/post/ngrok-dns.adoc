...
Spinning up link:/code/docker-compose-ngrok-kafka.yml[this Docker Compose] should have worked just fine (it did last year!). But for some reason my Kafka broker couldn't be reached (`Connection refused`).
