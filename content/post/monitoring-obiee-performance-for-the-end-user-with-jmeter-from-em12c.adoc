...
You can find details of building OBIEE JMeter scripts link:https://www.rittmanmead.com/blog/2013/03/performance-and-obiee-test-build/[here] and even a sample one to download link:https://gist.github.com/rmoff/5161818[here]. In the example I am building here the script consists of three simple steps:
