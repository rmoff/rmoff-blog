...
This defines a new writer than will write logs to disk (*FileLogWriter*), in 100MB files of which it’ll keep 10. If you’re defining additional Writers, make sure they have a unique *writerClassId* link:http://docs.oracle.com/cd/E21764_01/bi.1111/e10541/logging.htm#g1056592[See docs for detailed syntax].
