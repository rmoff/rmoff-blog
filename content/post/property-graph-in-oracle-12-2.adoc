...
Here we'll see this in action, using the same dataset as I've link:https://community.oracle.com/docs/DOC-1006400[previously used] - the "Panama Papers".


My starting point is the link:http://www.oracle.com/technetwork/community/developer-vm/[Oracle Developer Day VM], which at under 8GB is a tenth of the size of the beast that is the link:http://www.oracle.com/technetwork/database/bigdata-appliance/oracle-bigdatalite-2104726.html[BigDataLite VM]. BDL is great for exploring the vast Big Data ecosystem, both within and external to the Oracle world. However the Developer Day VM serves our needs perfectly here, having been recently updated for the 12.2 release of Oracle. You can also use DB 12.2 in Oracle Cloud, as well as the link:https://github.com/oracle/[Docker image].


== Prepare Database for Property Graph


_The steps below are based on Zhe Wu's blog "link:https://blogs.oracle.com/oraclespatial/entry/graph_database_says_hello_from2[Graph Database Says Hello from the Cloud (Part III)]", modified slightly for the differing SIDs etc on Developer Day VM._
...
Now let's load the data. I'm using the Oracle Flat File format here, having converted it from the original CSV format link:https://gist.github.com/rmoff/17025830c81e60d6446e34a37273f705[using R]. For more details of why and how, see my link:https://community.oracle.com/docs/DOC-1006400[article here].
...
You can also natively execute some of the Property Graph algorithms from PL/SQL itself. Here is how to run the link:https://docs.oracle.com/database/122/SPGDG/OPG_APIS-reference.htm#SPGDG-GUID-A5F629F8-D086-4E7F-8ECF-6094982E7A05[PageRank algorithm], which can be used to identify the most significant nodes in a graph, assigning them each a score (the "page rank" value):
...
Now you can use the Python interface to property graph (`pyopg`) from within Jupyter, as seen below. I've put the notebook on link:https://gist.github.com/rmoff/6637de06efe30f1ec230a088c2cf3969[gist.github.com] meaning that you can download it from there and run it yourself in Jupyter.
