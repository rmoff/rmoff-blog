...
As an example, let us examine a dashboard from link:http://www.oracle.com/technetwork/middleware/bi-foundation/obiee-samples-167534.html?ref=rittmanmead.com[SampleApp].
...
Conspicuous by its absence from the above is how we deal with ad-hoc reporting with OBIEE in our performance tests. This is the link:http://en.wikipedia.org/wiki/Elephant_in_the_room?ref=rittmanmead.com[elephant in the room] when it comes to performance testing OBIEE, because we cannot go through the same methodical process of cataloging the workload – because it is link:http://en.wikipedia.org/wiki/Ad_hoc?ref=rittmanmead.com#Ad_hoc_querying[ad hoc]. This is discussed in detail later.
...
For some reason, user concurrency is often a contentious number to define. With the greatest of apologies to link:https://www.youtube.com/watch?v=13JK5kChbRw&ref=rittmanmead.com[Monty Python], I offer this paraphasing of a familiar conversation:
...
[quote]
____
*_Before you can measure something you really need to lay down a very concrete definition of what you’re measuring._* – link:http://zedshaw.com/essays/programmer_stats.html?ref=rittmanmead.com[Zed Shaw]
____
...
Here’s an example test definition, put together from link:http://www.oracle.com/technetwork/middleware/bi-foundation/obiee-samples-167534.html?ref=rittmanmead.com[SampleAppv207].
