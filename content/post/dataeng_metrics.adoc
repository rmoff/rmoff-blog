...
It strikes me as conceptually similar to what #OBIEE did in its logical layer with measures. Admittedly it was almost always exposed through the tool's front end itself, but there *was* an ODBC and JDBC (link:/2016/03/28/connecting-to-obiee-via-jdbc-with-jisql/) API that other tools could have built against.
