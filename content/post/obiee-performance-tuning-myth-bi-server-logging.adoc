...
Cary Millsap's paper, link:http://method-r.com/downloads/doc_details/44-thinking-clearly-about-performance[Thinking Clearly About Performance], is an excellent starting point for developing an understanding of a logical and methodical approach to performance problem solving.


James Morle wrote an great blog post on the subject of "Best Practice" and why it is dangerous terminology, entitled link:http://www.scaleabilities.co.uk/2011/09/16/right-practice/["Right Practice"]
