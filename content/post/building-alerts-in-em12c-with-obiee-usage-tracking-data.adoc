...
Alerts within EM12c are primarily handled through *Incidents*, which are link:http://docs.oracle.com/cd/E25054_01/doc.1111/e24473/incident_mgmt.htm#BABGGCDA[concisely defined] as “[…a] situation or issue you need to act on”. Incidents are created from the occurence of one or more *Events*, which are basically something (not necessarily 'bad') that has been measured by EM12c and deemed of interest.


The reference manual gives a nice illustration of how events and incidents are related, link:http://docs.oracle.com/cd/E25054_01/doc.1111/e24473/incident_mgmt.htm#sthref14[here].
...
This is using the Usage Tracking RPD that comes with link:http://www.oracle.com/technetwork/middleware/bi-foundation/obiee-samples-167534.html[SampleApp v309R2], merged into the existing RPD running on my system. SampleApp also includes a comprehensive set of dashboards based on Usage Tracking data.
