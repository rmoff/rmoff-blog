...
Previously known as Oracle Stream Explorer, it is part of the SOA component of Fusion Middleware (just as OBIEE and ODI are part of FMW too). In link:https://blogs.oracle.com/emeapartnerdis/entry/oracle_stream_analytics_osa_within?ref=rittmanmead.com[a recent blog] it was positioned as _“[…] part of Oracle Data Integration And Governance Platform.”_. Its Big Data credentials include support for Kafka as source and target, as well as the option to execute across multiple nodes for scaling performance and capacity link:https://docs.oracle.com/middleware/12211/lcm/INOEP/toc.htm?ref=rittmanmead.com#INOEP-GUID-F62A2B65-A02F-4205-97E2-07F4D662DD3E[using Spark].


I’ve been exploring OSA from the comfort of my own Mac, courtesy of Docker and a link:https://guidoschmutz.wordpress.com/2016/06/12/providing-oracle-stream-analytics-12c-environment-using-docker/?ref=rittmanmead.com[Docker image for OSA] created by Guido Schmutz. The benefits of Docker are many and covered elsewhere, but what I loved about it in this instance was that I didn’t have to download a VM that was 10s of GB. Nor did I have to spend time learning how to install OSA from scratch, which whilst interesting wasn’t a priority compared to just trying to tool out and seeing what it could do. _[Update] it turns out that link:https://docs.oracle.com/middleware/12211/lcm/INOEP/toc.htm?ref=rittmanmead.com#INOEP-GUID-8CE0F958-876D-433C-939B-83A8C03A5FBE[installation is a piece of cake], and link:http://www.oracle.com/technetwork/middleware/complex-event-processing/downloads/index.html?ref=rittmanmead.com[the download] is less than 1Gb … but in general the principle still stands - Docker is a great way to get up and running quickly with something_
...
The first example I’ll show is the canonical big data/streaming example everywhere – Twitter. Twitter is even built into OSA as a Stream source. If you go to link:https://dev.twitter.com/?ref=rittmanmead.com[https://dev.twitter.com] you can get yourself a set of credentials enabling you to query the live Twitter firehose for given hashtags or users.
...
Let's look now at some more of the options available for transforming and 'wrangling' streaming data with OSA. Here I’m going to show how two streams can be joined together (link:https://www.youtube.com/watch?v=jyaLZHiJJnE&ref=rittmanmead.com[but not crossed]) based on a common field, and the resulting stream used as the input for a subsequent process. The data is simulated, using a CSV file (read by OSA on a loop) and OSA's Event Generator.
