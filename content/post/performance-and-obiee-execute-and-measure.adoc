...
As link:http://zedshaw.com/essays/programmer_stats.html?ref=rittmanmead.com[Zed Shaw] puts it:
...
On *Linux* and other *nix systems there is a swathe of tools available, my tool of choice being link:http://collectl.sourceforge.net/?ref=rittmanmead.com[collectl], optionally visualised through link:http://graphite.wikidot.com/?ref=rittmanmead.com[graphite] or link:https://github.com/paperlesspost/graphiti?ref=rittmanmead.com[graphiti]. There are plenty of alternatives, including sar, glance, and so on
...
Finally, it’s worth noting that JMeter also offers collection of OS stats through the link:http://code.google.com/p/jmeter-plugins/wiki/PerfMon?ref=rittmanmead.com[JMeter plugins project].
...
+
. Similar to *Performance Monitor* but with a lot more metrics available, link:http://docs.oracle.com/cd/E25054_01/core.1111/e10108/monitor.htm?ref=rittmanmead.com#CFAHIAIB[DMS Spy] is a java deployment hosted on the Admin Server by default, available at `http://<yourserver>:<adminserver port>/dms/Spy`
...
link:http://docs.oracle.com/cd/E23943_01/doc.1111/e14007/opmnctl.htm?ref=rittmanmead.com#CHDEFIDH[See the documentation for details]
. link:http://docs.oracle.com/cd/E25054_01/web.1111/e13813/custom_dms.htm?ref=rittmanmead.com#WLSTC2686[DMS through WLST]
. link:http://docs.oracle.com/cd/E23943_01/bi.1111/e10541/logging.htm?ref=rittmanmead.com#BABDIADI[BI Server diagnostics through ODBC/JDBC]
