...
After link:/2025/03/13/creating-an-http-source-connector-on-confluent-cloud-from-the-cli/[poking around the Confluent Cloud API for configuring connectors] I wanted to take a look at the same for Flink.
