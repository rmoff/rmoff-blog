...
To create an EMR cluster simply login to the EMR console and link:https://console.aws.amazon.com/elasticmapreduce/home?region=us-east-1#quick-create:[click Create]
...
To upload a file to S3 you can use the S3 web interface, or a tool such as link:https://cyberduck.io/[Cyberduck]. Better, if you like the command line as I do, is the link:https://aws.amazon.com/cli/[AWS CLI tools]. Once installed, you can run this from your local machine:
