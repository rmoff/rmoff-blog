...
I've previously written about the overall patching process link:https://www.rittmanmead.com/blog/2012/07/applying-patches-to-obiee-11-1-1-6-2-bp1/[here]. OPatch is part and parcel of an OBIEE sysadmin's life, so I wanted to share this short article to show the quicker way to apply the PSUs. It uses a more direct way than the patch documentation describes, taking advantage of the *`napply`* option of OPatch (link:http://docs.oracle.com/cd/B28359_01/em.111/b31207/oui7_opatch.htm?ref=rittmanmead.com#CHDCIGJC[documented here)]. By using this option `OPatch` will apply all listed patches in one go, rather than one at a time. As well as this, we can use the `silent` flag to stop `OPatch` from prompting to apply each patch in turn.


. Download the necessary patches - for 11.1.1.7.1 this is link:https://support.oracle.com/epmos/faces/ui/patch/PatchDetail.jspx?patchId=16569379&ref=rittmanmead.com[16569379] and link:https://support.oracle.com/epmos/faces/ui/patch/PatchDetail.jspx?patchId=16556157&ref=rittmanmead.com[16556157]. In a server environment you can use link:https://www.rittmanmead.com/blog/2012/07/downloading-obiee-patches-from-oracle-with-wget/[wget to download the patches as detailed here].
