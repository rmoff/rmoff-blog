...
**Be very careful with the above configuration files for any trailing whitespace** - it can cause problem, [detailed here](/2017/09/12/oracle-goldengate-/-kafka-connect-handler-troubleshooting/). 
