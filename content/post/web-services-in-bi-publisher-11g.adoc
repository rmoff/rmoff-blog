...
First, a quick refresher : what *is* a web service? I'd link:http://en.wikipedia.org/wiki/Web_service?ref=rittmanmead.com[hasten to Wikipedia for a formal definition], but in essence I would describe the salient points thus: 
...
You can find the documentation for BI Publisher Web Services in the link:http://docs.oracle.com/cd/E21764_01/bi.1111/e18863/toc.htm?ref=rittmanmead.com[Developer's Guide for BI Publisher].
...
Even once you're comfortable with a web service, you can use a tool like soapUI to sandbox your web service calls, and then it's a piece of cake to migrate them to your target client. You can download soapUI for free (there is also a Pro version, which isn't free) from link:http://www.soapui.org/?ref=rittmanmead.com[here], and it works on Windows, Mac and Linux. If you are using the Mac version, make sure you set "Use native Look & Feel" otherwise you won't get title bars in the desktop windows.
...
You can see a list of valid values in link:http://docs.oracle.com/cd/E21764_01/bi.1111/e18863/datatypes.htm?ref=rittmanmead.com#autoId48[the documentation].
